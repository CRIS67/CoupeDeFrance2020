...
#define PWM_PUMP                SDC2
#define PWM_MOTOR_LINEAR        PDC2

#define PWM_PR_PUMP             PHASE2
#define PWM_PR_MOTOR_LINEAR     SPHASE2

#define PWM_PR_L                PHASE3
#define PWM_PR_R                SPHASE3

#define SENS_PUMP               LATGbits.LATG12
#define SENS_MOTOR_LINEAR       LATGbits.LATG13

#define SENS_L      LATGbits.LATG1
#define SENS_R      LATGbits.LATG0
